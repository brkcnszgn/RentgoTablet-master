...
import com.creatifsoftware.filonova.databinding.FragmentAdditionalPhotosBinding;
 ...
 */
public class AdditionaPhotoFragment extends BaseFragment implements Injectable {
    ...
    public static AdditionaPhotoFragment forSelectedContract(ContractItem selectedContract) {
        AdditionaPhotoFragment fragment = new AdditionaPhotoFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_additional_photos, container, false);
    ...
    private void downloadPhoto(String imageName, int type) {
        String refName =
                BlobStorageManager.instance.prepareAdditionalImageName(selectedContract.selectedEquipment, selectedContract.contractNumber, imageName);
    ...
    private void upload() {
        Thread thread = new Thread(() -> {
            try {
                ...
                String extra_right_image = BlobStorageManager.instance.prepareAdditionalImageName(selectedContract.selectedEquipment, selectedContract.contractNumber,
                        "extra_right_image");
                String extra_left_image = BlobStorageManager.instance.prepareAdditionalImageName(selectedContract.selectedEquipment, selectedContract.contractNumber,
                        "extra_left_image");
                String extra_front_image = BlobStorageManager.instance.prepareAdditionalImageName(selectedContract.selectedEquipment, selectedContract.contractNumber,
                        "extra_front_image");
                String extra_rear_image = BlobStorageManager.instance.prepareAdditionalImageName(selectedContract.selectedEquipment, selectedContract.contractNumber,
                        "extra_rear_image");
                String extra_seat_rear_image = BlobStorageManager.instance.prepareAdditionalImageName(selectedContract.selectedEquipment, selectedContract.contractNumber,
                        "extra_seat_rear_image");
                String extra_seat_front_image = BlobStorageManager.instance.prepareAdditionalImageName(selectedContract.selectedEquipment, selectedContract.contractNumber,
